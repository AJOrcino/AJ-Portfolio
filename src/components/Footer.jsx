        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-center md:items-start">
          ...
          <div className="text-center">
            ...
            <div className="flex justify-center space-x-4 text-xl">
              <a href="https://github.com/AJOrcino" target="_blank" rel="noopener noreferrer" className="text-blue-500 bg-blue-500/10 rounded-full hover:bg-blue-500/20 hover:shadow-[0_2px_8px_rgba(59,130,246,0.1)] transition-all">
                <FaGithub />
              </a>
              ...
              <a href="https://www.linkedin.com/in/allen-jefferson-orcino-b82924322/" target="_blank" rel="noopener noreferrer" className="text-blue-500 bg-blue-500/10 rounded-sm hover:bg-blue-500/20 hover:shadow-[0_2px_8px_rgba(59,130,246,0.1)] transition-all">
                <FaLinkedin />
              </a>
          ...
          <div className="text-center">
            ...
            <p className='text-blue-500'>Email: allenjeffersonorcino@gmail.com</p>
          </div>
        </div>
